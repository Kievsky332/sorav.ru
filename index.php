...
<body>
    <div id="main">
        ...
        <div id="HI" class="divi">
            ...
            <div>
                <img class="menshe" src="https://emoji.aranja.com/emojis/apple/1f643.png">
                <p class="bolshe">12323</p>
            </div><br>
            <div>
                <img class="menshe"  src="https://uprostim.com/wp-content/uploads/2021/04/image084-3.png">
                <p class="bolshe">12323</p>
            </div>
